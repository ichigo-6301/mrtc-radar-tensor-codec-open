...
- 45 nm register-expanded 的 400 MHz 结果是 internal reg-to-reg academic timing。它使用 600 MHz setup-closed DC mapped netlist、OpenRCX SPEF 和 PrimeTime，但不覆盖 IO、OCV/MMMC、macro DRC/LVS/PEX 或 foundry signoff；
