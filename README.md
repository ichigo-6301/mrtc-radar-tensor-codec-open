...
|---|---|---|---|
| `register-expanded` | 标准单元寄存器，SRAM macro 数为 0 | 15 nm DC；45 nm DC + OpenROAD/OpenRCX + PrimeTime | 15 nm 800 MHz DC internal timing 通过；45 nm 使用 700 MHz closed DC netlist，在 550 MHz 完成 route 与 internal reg-to-reg STA |
