...
| ASIC | Nangate45 register-expanded 550 MHz 与双 OpenRAM SRAM-macro 333 MHz 均完成 OpenROAD P&R，并以 matching routed netlist/SDC、same-run OpenRCX SPEF 通过 PrimeTime post-route setup/hold STA；SRAM overall profile 仍为 partial |
