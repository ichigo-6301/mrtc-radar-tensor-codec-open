...
| Single-Engine pipeline A/B | Fixed 256-block ZERO_RICE historical RTL streams; average packet-completion spacing falls `8220 -> 785 cycles/block`, a `10.47×` speedup; the payload sub-interval is `7693 -> 721 cycles`, or `10.67×` | [YAML](evidence/rdtc_v1_bitpacker_pipeline_ab.yaml) · [CSV](evidence/data/rdtc_v1_bitpacker_pipeline_ab.csv) |
| Multi-Engine scaling | Fixed 256-block historical buffered-wrapper RTL workload; 1/2/4-Engine average block intervals are `785 / 397.52 / 197.41 cycles/block`, with `98.7368% / 99.4115%` scaling efficiency | [YAML](evidence/rdtc_v1_multiengine_rtl.yaml) · [CSV](evidence/data/rdtc_v1_multiengine_scaling.csv) |
